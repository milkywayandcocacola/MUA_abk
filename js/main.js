...
/*ADS_section_buttonc__click_functions*/
  $('#ad1').click(function(){
    $('#message').text('Здравствуйте! Я хочу записаться на полный курс "Профессия Лашмейкер" по акции.');
    });
  $('#ad2').click(function(){
    $('#message').text('Здравствуйте! Я хочу записаться на полный курс "Макияж для себя" по акции.');
    });
  $('#ad3').click(function(){
    $('#message').text('Здравствуйте! Я хочу получить скидку на Ваши услуги по акции "Свадебный образ".');
    });
...
//courses & services  
  ...
  $('#morebutton3').on("click", function () {
    $('#csiw3').hide();
    $('#csiw3fi').show();
  });
  $('.morebuttonback1').on("click", function () {
    $('#csiw1fi').hide();
    $('#csiw1').show();
  });
  $('.morebuttonback2').on("click", function () {
    $('#csiw2fi').hide();
    $('#csiw2').show();
  });
  $('.morebuttonback3').on("click", function () {
    $('#csiw3fi').hide();
    $('#csiw3').show();
  });
});
